...
declare -A JOBS=(
  ["sft_9b_v2_ext"]="/mnt/data/huggingface_downloads/models/qwen/Qwen3.5-9B output/sft_qwen35_9b/v0-20260407-011328/checkpoint-626 sft_style"
  ["topoprm_gated_9b_v2_ext"]="/mnt/data/huggingface_downloads/models/qwen/Qwen3.5-9B output/grpo_gated_qwen35_9b_mcl4096/v4-20260407-111747/checkpoint-79 sft_style"
  ["topoprm_hier_9b_v2_ext"]="/mnt/data/huggingface_downloads/models/qwen/Qwen3.5-9B output/grpo_hierarchical_qwen35_9b_mcl4096/v2-20260407-162048/checkpoint-79 sft_style"
)
