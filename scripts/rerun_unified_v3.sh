...
# ---------------------------------------------------------------------------
MODEL_BASE_9B="/mnt/data/huggingface_downloads/models/qwen/Qwen3.5-9B"
MODEL_BASE_4B="/mnt/data/huggingface_downloads/models/qwen/Qwen3.5-4B"
MODEL_BASE_Q25_7B="/mnt/data/huggingface_downloads/models/qwen/Qwen2.5-7B-Instruct"
