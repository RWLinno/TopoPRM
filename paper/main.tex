...
0.7, top-$p$ 0.95, and max completion length 2{,}048. vLLM (colocate
mode) accelerates generation. Training runs for 1 epoch with learning
rate $5 \times 10^{-6}$, cosine decay, batch size 1, and gradient
accumulation 4.
