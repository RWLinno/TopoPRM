...
MODEL_PATH="${1:-${MODEL_ROOT}/Qwen/Qwen3.5-9B}"
ADAPTER_ARG="${2:-}"
LABEL_ARG="${3:-}"

PYTHON_BIN="${TOPOPRM_PYTHON:-${PYTHON_ENV_BIN}/python}"
...
EVAL_OUTPUT_DIR="${EVAL_OUTPUT_DIR:-${EXP_ROOT}/canonical/eval}"
