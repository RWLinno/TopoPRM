...
###############################################################################
# Evaluate ALL trained models on the internal held-out set (not part of the
# public benchmarks reported here) plus the public benchmarks.
...
# ─── 2) GRPO variants (internal held-out set) ───
echo ""
echo "─── GRPO Variants (Internal Held-Out Set) ───"
