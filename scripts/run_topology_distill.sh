...
STUDENT_MODEL="${STUDENT_MODEL:-/knowin-oss/weilinruan/models/Qwen3.5-4B}"
TEACHER_MODEL="${TEACHER_MODEL:-/Knowin/foundation/weilinruan/hf_models/Qwen/Qwen3.5-9B}"
TEACHER_ADAPTER="${TEACHER_ADAPTER:-}"
DISTILL_ROOT="${DISTILL_ROOT:-/knowin-oss/weilinruan/TopoPRM_ICLR27/canonical/distill_data/${DISTILL_VARIANT}}"
PROMPT_DATA="${PROMPT_DATA:-/knowin-oss/weilinruan/TopoPRM_ICLR27/canonical/grpo_data/train_no_eval_overlap_max512.jsonl}"
