...
class ContinuityReward(ORM):
    ...
    markers such as "given" / "by the problem statement" (matched in both
    English and Chinese via ``_GIVEN_PATTERNS``) are treated as automatically
    continuous, since they cite the problem statement.
